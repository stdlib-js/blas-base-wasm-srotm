...
```javascript
import srotm from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-srotm@v0.1.0-deno/mod.js';
```
...
[@stdlib/blas/base/srotm]: https://github.com/stdlib-js/blas-base-srotm/tree/deno
